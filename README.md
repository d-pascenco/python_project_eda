...
Логическим продолжением анализа стал проек [с моделями машинного обучения для поиска потенциально недооценённых AI/ML-проектов](https://github.com/d-pascenco/ML_project_team_Tro_Sam_Ser_Pas). Он развивает ту же тему на отдельной зафиксированной выгрузке GitHub API с дополнительными признаками, необходимыми для построения моделей.
